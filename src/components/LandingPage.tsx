      ...
      <header className="w-full bg-white/90 backdrop-blur-md border-b border-emerald-100 sticky top-0 z-50 shadow-2xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8 text-sm font-bold text-neutral-600">
            <a href="#categories-section" className="hover:text-emerald-600 transition-colors">Task Categories</a>
            <a href="#features-section" className="hover:text-emerald-600 transition-colors">Platform Features</a>
      ...
      <main className="flex-grow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 lg:pt-20 lg:pb-32 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center space-x-2 bg-emerald-50 border border-emerald-100 px-3.5 py-1.5 rounded-full text-xs font-bold text-emerald-700">
          ...
          <div className="lg:col-span-5 relative">
            <div className="bg-white rounded-3xl p-6 shadow-2xl border border-emerald-100 space-y-6 relative z-10">
              ...
              <div className="space-y-3 bg-emerald-50/50 p-4 rounded-2xl border border-emerald-100">
                <div className="flex items-center justify-between text-xs font-bold text-emerald-900">
                  ...
                  <span className="bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded-md text-[10px]">$0.15 Reward</span>
                </div>
              ...
              <div className="bg-emerald-50/80 p-3.5 rounded-2xl border border-emerald-100 flex items-center justify-between">
                <div className="flex items-center space-x-2.5">
                  ...
                  <span className="text-xs font-bold text-emerald-950">KYC Verified Geo-Targeting Active</span>
                </div>
                <span className="text-xs font-bold text-emerald-600">Protected</span>
              </div>
            </div>

            <div className="absolute -inset-4 bg-gradient-to-tr from-emerald-200 to-teal-100 rounded-3xl blur-2xl opacity-45 -z-10"></div>
          </div>
        </div>
              ...
              {CATEGORIES.map((cat) => (
                ...
                >
                  <div className="space-y-2">
                    <div className="h-10 w-10 rounded-xl bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-sm group-hover:scale-110 transition-transform">
                      ✓
                    </div>
                    <div>
                      <h3 className="font-extrabold text-neutral-900 text-base group-hover:text-emerald-600 transition-colors">
                        {cat.name}
                      </h3>
